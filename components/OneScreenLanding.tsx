    ...
    <main className="hhs-rotating-landing">
      ...
      <div className="hhs-fixed-message">
        ...
        <p className="hhs-main-copy">
          Upload once. HHS automatically organizes your evidence, maps it to every
          applicable accreditation standard, and keeps your organization
      ...
      <section className="hhs-rotating-panel">

        <div className="hhs-slide-card" key={current}>

          <p className="hhs-slide-eyebrow">
            {slide.eyebrow}
          </p>

          <h2>{slide.title}</h2>

          <p className="hhs-slide-description">
            {slide.description}
          </p>
          ...
          <div className="hhs-slide-visual">
            ...
            <div className="hhs-visual-header">
              ...
              <span className="hhs-status-pill">
                Live
              </span>
